...
// JSFunctionBuildSpec defines the desired state of JSFunctionBuild
...
// JSFunctionBuildStatus defines the observed state of JSFunctionBuild
// +k8s:openapi-gen=true
...
// JSFunctionBuild is the Schema for the jsfunctionbuilds API
// +k8s:openapi-gen=true
...
func init() {
	SchemeBuilder.Register(&JSFunctionBuild{}, &JSFunctionBuildList{})
}
